...
If (isset($_POST['txtdest']))
{
    ...
    $mailer->Host = 'smtp.testesuporte.tecnologia.ws'; //smtp.dominio.com.br
    $mailer->SMTPAuth = true; //define se haverá ou não autenticação no SMTP
    $mailer->Username = 'form@testesuporte.tecnologia.ws'; //Informe o e-mai o completo
    $mailer->Password = 'Loc1401$O09'; //Senha da caixa postal
    $mailer->FromName = $assunto; //Nome que será exibido para o destinatário
    $mailer->From = 'form@testesuporte.tecnologia.ws'; //Obrigatório ser a mesma caixa postal indicada em "username"
